...
import img1 from "./newsImg/news1.png"
import img2 from "./newsImg/news2.png"
import img3 from "./newsImg/news3.png"
import img4 from "./newsImg/news4.png"
import img5 from "./newsImg/news5.png"
...
const News = () => {
    ...
    },
    {
        ...
        `,
        moreInfo:`Microstrategy Acquires More Bitcoin Nasdaq-listed Microstrategy Inc. announced Wednesday that it has purchased more bitcoin for its corporate treasury. Michael Saylor, the company’s founder and executive chairman, tweeted Wednesday:
    ...
    },
    {
        ...
        `,
        moreInfo:`Miners were dealing with a variety of issues, including defaulted loans, quarterly losses, and soaring bitcoin hashrates that reached all-time highs. All these factors were affecting the profitability of the miners and were causing sell pressure.
    ...
    },
    {
        ...
        poster:img5,
        description:`The investor drained $110 million in cryptocurrencies from the platform.
        ...
        `,
        moreInfo:`The self-described game theorist admitted his role in draining Mango Markets’ treasury shortly after the incident in mid-October, and may now be the first U.S. resident to face charges for his role in manipulating a decentralized-finance trading platform.
